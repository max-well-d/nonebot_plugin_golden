...
class Config(BaseModel, extra=Extra.ignore):
	...
	__plugin_usage__ = """金碟模拟器帮助：
	    ...
	    8、买幻卡包(买包，买幻卡)?[卡包种类]?[购买个数]：购买幻卡包，有1：铜包(100金碟币)、2：银包(300金碟币)、3：金包(500金碟币)、4：白金包(1500金碟币)四种
	    9、开幻卡包(开包，开幻卡)?[卡包种类]?[开启个数]：开启幻卡包，随机获得1~5星幻卡
	    10、开卡记录(开包记录,幻卡记录)：显示已开的卡包数和获得的幻卡张数
	    11、金碟帮助(/help)：显示帮助
	    12、我的金碟币(金碟币)：显示剩余金碟币数量
	    13、生涯数据(我的数据，我的战绩)：显示金碟币使用获得，幻卡战力，幻卡对战数据，仙人彩购买情况
	    14、排行榜(金碟币排行，仙人彩排行，[幻卡战力排行，战力排行]，赚币排行，花币排行，签到排行)：各种排行榜"""
